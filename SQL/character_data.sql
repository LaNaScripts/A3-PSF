...
-- Dumping structure for table 2017-hivemind-dev.character_data
CREATE TABLE IF NOT EXISTS `character_data` (
  ...
  `Inventory` longtext,
  `PrimaryWeapon` longtext,
  `SecondaryWeapon` longtext,
  `SideWeapon` longtext,
  `Backpack` longtext,
  `Vest` longtext,
  `Uniform` longtext,
  ...
  `Sanity` int(11) NOT NULL DEFAULT '2500',
